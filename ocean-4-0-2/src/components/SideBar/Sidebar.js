...
const Sidebar = ({children}) => {
    ...
    return (
        <div className="container">
           <div style={{width: isOpen ? "200px" : "50px",zIndex: isOpen ? 1000 : 0,}} className="sidebar">
               <div className="top_section">
               <img src={logo} width={100} height={20} style={{display: isOpen ? "block" : "none"}} className="logo" alt="Aceslogo"/>
