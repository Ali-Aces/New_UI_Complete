  ...
  return (
    ...
    <Sidebar />
      ...
      <div className="third-line">
        ...
        <Filter />
        <Condition />
        <select id="sort" onChange={handleSorting} className="all-component-btn">
          <option value="null">Sort</option>
          <option value="ascending">Ascending</option>
          <option value="descending">Descending</option>
        </select>
        <select id="scope" onChange={(e) => setScopeMap(e.target.value)}className="all-component-btn">
        ...
        <Granularity drop={handleDrop} deleteValues={deleteValues} />
          ...
          <Scrollbars style={{ overflow: "hidden", height: "375px" }}>
            <div
              id="plots"
              // style={{
              //   overflowY: "auto",
